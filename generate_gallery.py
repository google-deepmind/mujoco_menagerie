...
Requirements:
pip install dm_control pillow numpy tqdm mdutils opencv-python

Instructions:
`python generate_gallery.py` will create a markdown document called `gallery.md`
with a table of images. Copy this table into README.md to display the images.
"""
...
MODEL_XMLS = [Path(f"{k}.xml") for k in MODEL_MAP.keys()]
