...
Wave** dexterous hand developed by
[Sharpa](https://www.sharpa.com/). The hand has 22 degrees of
freedom across the thumb (5 DoF), index/middle/ring fingers (4 DoF each), and
pinky (5 DoF), and integrates Sharpa's
[fingertip tactile sensors](https://www.sharpa.com/pages/wave) modeled here
...
(commit
[`3e953f5`](https://github.com/sharpa-robotics/sharpa-urdf-usd-xml/commit/3e953f588ba9954cebaa720aaa4cee06a43a068e)).
